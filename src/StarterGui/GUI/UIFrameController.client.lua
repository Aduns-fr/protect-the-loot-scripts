...
bind(hud:FindFirstChild("Weapons") or hud:FindFirstChild("Swords"),frames:FindFirstChild("Weapons") and "Weapons" or "Swords"); bind(hud:FindFirstChild("Settings"),"Settings"); bind(hud:FindFirstChild("Shop"),"Shop"); bind(hud:FindFirstChild("Codes"),"Codes"); bind(hud:FindFirstChild("Maps") or hud:FindFirstChild("Badges"),"Maps")
